...
- Canonical source (current rollout branch): [github.com/Borgels/vaner/blob/feat/install-oneliner/scripts/install.sh](https://github.com/Borgels/vaner/blob/feat/install-oneliner/scripts/install.sh)
