...
- Served script: [vaner.ai/install.sh](https://vaner.ai/install.sh)

```bash
diff <(curl -s https://vaner.ai/install.sh) <(curl -s https://raw.githubusercontent.com/Borgels/Vaner/main/scripts/install.sh)
```
