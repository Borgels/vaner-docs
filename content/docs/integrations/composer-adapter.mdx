...
The first official adapter ships in the [Claude Code plugin](/integrations/tools/claude-code-mcp)
...
- Stales automatically when the user clears or abandons the draft —
  no wasted preparation on dead branches.
